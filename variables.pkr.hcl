...
variable "vagrant_ssh_username" {
  type        = string
  description = "The username to configure for vagrant to connect to SSH with. Required if using SSH"
  default     = "vagrant"
}

variable "vagrant_ssh_password" {
  type        = string
  description = "A plaintext password to use for vagrant to to authenticate with SSH"
  default     = "vagrant"
}
